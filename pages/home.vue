  ...
  <div class="app-container flex flex-col items-center justify-center space-y-4">
    ...
    <div class="content md:w-1/3">
      ...
      <textarea id="message" rows="4"
        class="textarea  block p-2.5 w-2/3 text-[16px] text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
